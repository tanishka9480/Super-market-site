<%@ Page Title="" Language="C#" MasterPageFile="~/SuperMarket.master" AutoEventWireup="true" CodeFile="SuperMarketFood.aspx.cs" Inherits="_Default" %>
 ...
 <div style="float: initial; width: initial; height:initial">
        <fieldset class="fieldsetmain">
            ...
            <asp:TextBox ID="txtQty" runat="server" Width="30" Height="20" Text="1" style="text-align:center" > </asp:TextBox><asp:Label ID="UnitLabel" runat="server" Text='<%# Eval("Unit") %>' />
                                ...
                                <asp:Button ID="btnAddToCart" runat="server" Text="Add To Cart" autopostback="true" CssClass="button" causesvalidation="true" OnClick="btnAddToCart_Click" />
                            </td>
