<%@ Page Title="" Language="C#" MasterPageFile="~/SuperMarket.master" AutoEventWireup="true" CodeFile="SuperMarketBakeryCakes.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="float: initial; width: initial; height:initial">
        <fieldset class="fieldsetmain">
            <legend style="font-size: 20px;">Bakery,Cakes & Dairy</legend>
