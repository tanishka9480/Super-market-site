<%@ Page Title="" Language="C#" MasterPageFile="~/SuperMarket.master" AutoEventWireup="true" CodeFile="SuperMarketProducts.aspx.cs" Inherits="_Default" %>
...
<div style="float: left; width: initial; height:initial">
        <fieldset class="fieldsetmain">
            ...
            <asp:DataList runat="server" ID="gvProduct" RepeatDirection="Horizontal" RepeatColumns="6">
                <ItemTemplate>
            ...
            <asp:TextBox ID="txtQty" runat="server" Width="30" Height="20" Text="1" style="text-align:center" > </asp:TextBox><asp:Label ID="UnitLabel" runat="server" Text='<%# Eval("Unit") %>' />
                                ...
                                <asp:Button ID="btnAddToCart" runat="server" Text="Add To Cart"  autopostback="true" CssClass="button"  causesvalidation="true"  OnClick="btnAddToCart_Click"/></center>
                            </td>
